...
@InputType()
export class manager_withdrawUpsertWithWhereUniqueWithoutManager_withdraw_organizationsInput {
    ...
    update!: manager_withdrawUpdateWithoutManager_withdraw_organizationsInput;
