...
import { usersUpdateOneRequiredWithoutManager_withdraw_couriersNestedInput } from '../users/users-update-one-required-without-manager-withdraw-couriers-nested.input';
...
@InputType()
export class manager_withdrawUpdateWithoutManager_withdraw_transactions_withdrawInput {
    ...
    @Field(() => usersUpdateOneRequiredWithoutManager_withdraw_couriersNestedInput, {nullable:true})
    manager_withdraw_couriers?: usersUpdateOneRequiredWithoutManager_withdraw_couriersNestedInput;
