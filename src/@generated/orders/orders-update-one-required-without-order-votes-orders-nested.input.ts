...
import { ordersUpsertWithoutOrder_votes_ordersInput } from './orders-upsert-without-order-votes-orders.input';
import { ordersWhereUniqueInput } from './orders-where-unique.input';
import { ordersUpdateWithoutOrder_votes_ordersInput } from './orders-update-without-order-votes-orders.input';

@InputType()
export class ordersUpdateOneRequiredWithoutOrder_votes_ordersNestedInput {
    ...
    @Field(() => ordersUpsertWithoutOrder_votes_ordersInput, {nullable:true})
    @Type(() => ordersUpsertWithoutOrder_votes_ordersInput)
    upsert?: ordersUpsertWithoutOrder_votes_ordersInput;

    @Field(() => ordersWhereUniqueInput, {nullable:true})
    @Type(() => ordersWhereUniqueInput)
    connect?: ordersWhereUniqueInput;

    @Field(() => ordersUpdateWithoutOrder_votes_ordersInput, {nullable:true})
