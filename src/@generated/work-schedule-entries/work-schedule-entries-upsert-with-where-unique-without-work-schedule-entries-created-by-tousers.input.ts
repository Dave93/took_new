...
import { work_schedule_entriesUpdateWithoutWork_schedule_entries_created_byTousersInput } from './work-schedule-entries-update-without-work-schedule-entries-created-by-tousers.input';
...
@InputType()
export class work_schedule_entriesUpsertWithWhereUniqueWithoutWork_schedule_entries_created_byTousersInput {
    ...
    @Field(() => work_schedule_entriesUpdateWithoutWork_schedule_entries_created_byTousersInput, {nullable:false})
    @Type(() => work_schedule_entriesUpdateWithoutWork_schedule_entries_created_byTousersInput)
    update!: work_schedule_entriesUpdateWithoutWork_schedule_entries_created_byTousersInput;
