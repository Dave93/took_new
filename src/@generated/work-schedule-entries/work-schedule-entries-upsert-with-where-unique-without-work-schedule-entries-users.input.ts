...
@InputType()
export class work_schedule_entriesUpsertWithWhereUniqueWithoutWork_schedule_entries_usersInput {
    ...
    update!: work_schedule_entriesUpdateWithoutWork_schedule_entries_usersInput;
