...
@InputType()
export class work_schedule_entriesUpsertWithWhereUniqueWithoutWork_schedule_entries_updated_byTousersInput {
    ...
    update!: work_schedule_entriesUpdateWithoutWork_schedule_entries_updated_byTousersInput;
