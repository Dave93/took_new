...
import { work_schedulesCreateNestedOneWithoutWork_schedule_entries_work_schedulesInput } from '../work-schedules/work-schedules-create-nested-one-without-work-schedule-entries-work-schedules.input';

@InputType()
export class work_schedule_entriesCreateWithoutWork_schedule_entries_updated_byTousersInput {
    ...
    @Field(() => work_schedulesCreateNestedOneWithoutWork_schedule_entries_work_schedulesInput, {nullable:false})
    work_schedule_entries_work_schedules!: work_schedulesCreateNestedOneWithoutWork_schedule_entries_work_schedulesInput;
}
