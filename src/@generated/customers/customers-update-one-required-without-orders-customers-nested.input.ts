...
import { customersUpsertWithoutOrders_customersInput } from './customers-upsert-without-orders-customers.input';
...
@InputType()
export class customersUpdateOneRequiredWithoutOrders_customersNestedInput {
    ...
    @Field(() => customersUpsertWithoutOrders_customersInput, {nullable:true})
    @Type(() => customersUpsertWithoutOrders_customersInput)
    upsert?: customersUpsertWithoutOrders_customersInput;

    @Field(() => customersWhereUniqueInput, {nullable:true})
    @Type(() => customersWhereUniqueInput)
    connect?: customersWhereUniqueInput;

    @Field(() => customersUpdateWithoutOrders_customersInput, {nullable:true})
