...
@InputType()
export class order_actionsUpsertWithWhereUniqueWithoutOrder_actions_created_byTousersInput {
    ...
    update!: order_actionsUpdateWithoutOrder_actions_created_byTousersInput;
