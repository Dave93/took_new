...
import { postUpdateManyWithoutUsers_post_created_byTousersInput } from '../post/post-update-many-without-users-post-created-by-tousers.input';
...
export class usersUpdateWithoutPost_prop_types_updated_byTousersInput {
    ...
    @Field(() => postUpdateManyWithoutUsers_post_created_byTousersInput, {nullable:true})
    post_post_created_byTousers?: postUpdateManyWithoutUsers_post_created_byTousersInput;
