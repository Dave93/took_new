...
import { order_votesUpdateManyWithoutOrder_votes_created_byTousersNestedInput } from '../order-votes/order-votes-update-many-without-order-votes-created-by-tousers-nested.input';
import { order_votesUpdateManyWithoutOrder_votes_couriersNestedInput } from '../order-votes/order-votes-update-many-without-order-votes-couriers-nested.input';
import { order_transactionsUpdateManyWithoutOrder_transactions_created_byTousersNestedInput } from '../order-transactions/order-transactions-update-many-without-order-transactions-created-by-tousers-nested.input';
import { order_transactionsUpdateManyWithoutOrder_transactions_couriersNestedInput } from '../order-transactions/order-transactions-update-many-without-order-transactions-couriers-nested.input';
import { outside_requestsUpdateManyWithoutOutside_requests_created_byTousersNestedInput } from '../outside-requests/outside-requests-update-many-without-outside-requests-created-by-tousers-nested.input';
import { outside_requestsUpdateManyWithoutOutside_requests_updated_byTousersNestedInput } from '../outside-requests/outside-requests-update-many-without-outside-requests-updated-by-tousers-nested.input';
import { courier_terminal_balanceUpdateManyWithoutCourier_terminal_balance_couriersNestedInput } from '../courier-terminal-balance/courier-terminal-balance-update-many-without-courier-terminal-balance-couriers-nested.input';
import { courier_terminal_balanceUpdateManyWithoutCourier_terminal_balance_created_byTousersNestedInput } from '../courier-terminal-balance/courier-terminal-balance-update-many-without-courier-terminal-balance-created-by-tousers-nested.input';
import { manager_withdrawUpdateManyWithoutManager_withdraw_created_byTousersNestedInput } from '../manager-withdraw/manager-withdraw-update-many-without-manager-withdraw-created-by-tousers-nested.input';
import { manager_withdrawUpdateManyWithoutManager_withdraw_managersNestedInput } from '../manager-withdraw/manager-withdraw-update-many-without-manager-withdraw-managers-nested.input';
import { manager_withdrawUpdateManyWithoutManager_withdraw_couriersNestedInput } from '../manager-withdraw/manager-withdraw-update-many-without-manager-withdraw-couriers-nested.input';
import { timesheetUpdateManyWithoutTimesheet_usersNestedInput } from '../timesheet/timesheet-update-many-without-timesheet-users-nested.input';
import { scheduled_reports_subscriptionUpdateManyWithoutScheduled_reports_subscription_usersNestedInput } from '../scheduled-reports-subscription/scheduled-reports-subscription-update-many-without-scheduled-reports-subscription-users-nested.input';
import { order_bonus_pricingUpdateManyWithoutUsers_order_bonus_pricing_created_byTousersNestedInput } from '../order-bonus-pricing/order-bonus-pricing-update-many-without-users-order-bonus-pricing-created-by-tousers-nested.input';
import { order_bonus_pricingUpdateManyWithoutUsers_order_bonus_pricing_updated_byTousersNestedInput } from '../order-bonus-pricing/order-bonus-pricing-update-many-without-users-order-bonus-pricing-updated-by-tousers-nested.input';
import { order_bonus_pricingUpdateManyWithoutCourierNestedInput } from '../order-bonus-pricing/order-bonus-pricing-update-many-without-courier-nested.input';

@InputType()
export class usersUpdateWithoutWork_schedule_entries_created_byTousersInput {
    ...
    @Field(() => order_votesUpdateManyWithoutOrder_votes_created_byTousersNestedInput, {nullable:true})
    order_votes_created_byTousers?: order_votesUpdateManyWithoutOrder_votes_created_byTousersNestedInput;

    @Field(() => order_votesUpdateManyWithoutOrder_votes_couriersNestedInput, {nullable:true})
    order_votes_couriers?: order_votesUpdateManyWithoutOrder_votes_couriersNestedInput;

    @Field(() => order_transactionsUpdateManyWithoutOrder_transactions_created_byTousersNestedInput, {nullable:true})
    order_transactions_created_byTousers?: order_transactionsUpdateManyWithoutOrder_transactions_created_byTousersNestedInput;

    @Field(() => order_transactionsUpdateManyWithoutOrder_transactions_couriersNestedInput, {nullable:true})
    order_transactions_couriers?: order_transactionsUpdateManyWithoutOrder_transactions_couriersNestedInput;

    @Field(() => outside_requestsUpdateManyWithoutOutside_requests_created_byTousersNestedInput, {nullable:true})
    outside_requests_created_byTousers?: outside_requestsUpdateManyWithoutOutside_requests_created_byTousersNestedInput;

    @Field(() => outside_requestsUpdateManyWithoutOutside_requests_updated_byTousersNestedInput, {nullable:true})
    outside_requests_updated_byTousers?: outside_requestsUpdateManyWithoutOutside_requests_updated_byTousersNestedInput;

    @Field(() => courier_terminal_balanceUpdateManyWithoutCourier_terminal_balance_couriersNestedInput, {nullable:true})
    courier_terminal_balance_couriers?: courier_terminal_balanceUpdateManyWithoutCourier_terminal_balance_couriersNestedInput;

    @Field(() => courier_terminal_balanceUpdateManyWithoutCourier_terminal_balance_created_byTousersNestedInput, {nullable:true})
    courier_terminal_balance_created_byTousers?: courier_terminal_balanceUpdateManyWithoutCourier_terminal_balance_created_byTousersNestedInput;

    @Field(() => manager_withdrawUpdateManyWithoutManager_withdraw_created_byTousersNestedInput, {nullable:true})
    manager_withdraw_created_byTousers?: manager_withdrawUpdateManyWithoutManager_withdraw_created_byTousersNestedInput;

    @Field(() => manager_withdrawUpdateManyWithoutManager_withdraw_managersNestedInput, {nullable:true})
    manager_withdraw_managers?: manager_withdrawUpdateManyWithoutManager_withdraw_managersNestedInput;

    @Field(() => manager_withdrawUpdateManyWithoutManager_withdraw_couriersNestedInput, {nullable:true})
    manager_withdraw_couriers?: manager_withdrawUpdateManyWithoutManager_withdraw_couriersNestedInput;

    @Field(() => timesheetUpdateManyWithoutTimesheet_usersNestedInput, {nullable:true})
    timesheet_users?: timesheetUpdateManyWithoutTimesheet_usersNestedInput;

    @Field(() => scheduled_reports_subscriptionUpdateManyWithoutScheduled_reports_subscription_usersNestedInput, {nullable:true})
    scheduled_reports_subscription_users?: scheduled_reports_subscriptionUpdateManyWithoutScheduled_reports_subscription_usersNestedInput;

    @Field(() => order_bonus_pricingUpdateManyWithoutUsers_order_bonus_pricing_created_byTousersNestedInput, {nullable:true})
    order_bonus_pricing_created_byTousers?: order_bonus_pricingUpdateManyWithoutUsers_order_bonus_pricing_created_byTousersNestedInput;

    @Field(() => order_bonus_pricingUpdateManyWithoutUsers_order_bonus_pricing_updated_byTousersNestedInput, {nullable:true})
    order_bonus_pricing_updated_byTousers?: order_bonus_pricingUpdateManyWithoutUsers_order_bonus_pricing_updated_byTousersNestedInput;

    @Field(() => order_bonus_pricingUpdateManyWithoutCourierNestedInput, {nullable:true})
    order_bonus_pricing_courier_idTusers?: order_bonus_pricingUpdateManyWithoutCourierNestedInput;
}
