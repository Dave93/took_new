...
import { roles_permissionsAvgOrderByAggregateInput } from './roles-permissions-avg-order-by-aggregate.input';
...
import { roles_permissionsSumOrderByAggregateInput } from './roles-permissions-sum-order-by-aggregate.input';
...
export class roles_permissionsOrderByWithAggregationInput {
    ...
    @Field(() => roles_permissionsAvgOrderByAggregateInput, {nullable:true})
    ...
    @Field(() => roles_permissionsSumOrderByAggregateInput, {nullable:true})
