...
@InputType()
export class roles_permissionsUpdateWithWhereUniqueWithoutUsers_roles_permissions_updated_byTousersInput {
    ...
    data!: roles_permissionsUpdateWithoutUsers_roles_permissions_updated_byTousersInput;
}
