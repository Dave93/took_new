...
import { usersUpdateOneWithoutOrder_bonus_pricing_updated_byTousersNestedInput } from '../users/users-update-one-without-order-bonus-pricing-updated-by-tousers-nested.input';
...
@InputType()
export class order_bonus_pricingUpdateWithoutUsers_order_bonus_pricing_created_byTousersInput {
    ...
    @Field(() => usersUpdateOneWithoutOrder_bonus_pricing_updated_byTousersNestedInput, {nullable:true})
    users_order_bonus_pricing_updated_byTousers?: usersUpdateOneWithoutOrder_bonus_pricing_updated_byTousersNestedInput;
