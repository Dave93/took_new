...
import { order_bonus_pricingUpdateWithoutUsers_order_bonus_pricing_created_byTousersInput } from './order-bonus-pricing-update-without-users-order-bonus-pricing-created-by-tousers.input';
...
@InputType()
export class order_bonus_pricingUpsertWithWhereUniqueWithoutUsers_order_bonus_pricing_created_byTousersInput {
    ...
    @Field(() => order_bonus_pricingUpdateWithoutUsers_order_bonus_pricing_created_byTousersInput, {nullable:false})
    @Type(() => order_bonus_pricingUpdateWithoutUsers_order_bonus_pricing_created_byTousersInput)
    update!: order_bonus_pricingUpdateWithoutUsers_order_bonus_pricing_created_byTousersInput;
