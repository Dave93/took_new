...
@InputType()
export class customers_commentsUpdateWithWhereUniqueWithoutCustomers_comments_image_idToassetsInput {
    ...
    data!: customers_commentsUpdateWithoutCustomers_comments_image_idToassetsInput;
}
