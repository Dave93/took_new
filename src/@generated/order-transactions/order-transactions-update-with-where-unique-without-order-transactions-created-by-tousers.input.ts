...
@InputType()
export class order_transactionsUpdateWithWhereUniqueWithoutOrder_transactions_created_byTousersInput {
    ...
    data!: order_transactionsUpdateWithoutOrder_transactions_created_byTousersInput;
}
