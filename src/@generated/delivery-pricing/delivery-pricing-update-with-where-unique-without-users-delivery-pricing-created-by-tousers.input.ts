...
@InputType()
export class delivery_pricingUpdateWithWhereUniqueWithoutUsers_delivery_pricing_created_byTousersInput {
    ...
    data!: delivery_pricingUpdateWithoutUsers_delivery_pricing_created_byTousersInput;
}
