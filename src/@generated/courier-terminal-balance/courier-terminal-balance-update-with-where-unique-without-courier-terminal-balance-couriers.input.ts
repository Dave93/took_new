...
@InputType()
export class courier_terminal_balanceUpdateWithWhereUniqueWithoutCourier_terminal_balance_couriersInput {
    ...
    data!: courier_terminal_balanceUpdateWithoutCourier_terminal_balance_couriersInput;
}
