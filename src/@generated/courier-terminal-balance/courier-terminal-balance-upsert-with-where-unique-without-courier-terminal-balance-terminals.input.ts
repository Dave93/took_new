...
@InputType()
export class courier_terminal_balanceUpsertWithWhereUniqueWithoutCourier_terminal_balance_terminalsInput {
    ...
    update!: courier_terminal_balanceUpdateWithoutCourier_terminal_balance_terminalsInput;
