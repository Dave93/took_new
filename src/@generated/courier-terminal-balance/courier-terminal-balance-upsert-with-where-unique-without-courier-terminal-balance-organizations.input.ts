...
@InputType()
export class courier_terminal_balanceUpsertWithWhereUniqueWithoutCourier_terminal_balance_organizationsInput {
    ...
    update!: courier_terminal_balanceUpdateWithoutCourier_terminal_balance_organizationsInput;

    @Field(() => courier_terminal_balanceCreateWithoutCourier_terminal_balance_organizationsInput, {nullable:false})
    @Type(() => courier_terminal_balanceCreateWithoutCourier_terminal_balance_organizationsInput)
    create!: courier_terminal_balanceCreateWithoutCourier_terminal_balance_organizationsInput;
}
