...
import { post_prop_typesUpdateWithoutUsers_post_prop_types_created_byTousersInput } from './post-prop-types-update-without-users-post-prop-types-created-by-tousers.input';
...
@InputType()
export class post_prop_typesUpsertWithWhereUniqueWithoutUsers_post_prop_types_created_byTousersInput {
    ...
    @Field(() => post_prop_typesUpdateWithoutUsers_post_prop_types_created_byTousersInput, {nullable:false})
    @Type(() => post_prop_typesUpdateWithoutUsers_post_prop_types_created_byTousersInput)
    update!: post_prop_typesUpdateWithoutUsers_post_prop_types_created_byTousersInput;
