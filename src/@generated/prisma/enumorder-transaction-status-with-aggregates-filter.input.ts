...
import { NestedEnumorder_transaction_statusWithAggregatesFilter } from './nested-enumorder-transaction-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumorder_transaction_statusFilter } from './nested-enumorder-transaction-status-filter.input';

@InputType()
export class Enumorder_transaction_statusWithAggregatesFilter {
