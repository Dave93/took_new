...
import { NestedEnumprice_typeWithAggregatesFilter } from './nested-enumprice-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumprice_typeFilter } from './nested-enumprice-type-filter.input';

@InputType()
export class Enumprice_typeWithAggregatesFilter {
