...
import { NestedEnumuser_statusWithAggregatesFilter } from './nested-enumuser-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumuser_statusFilter } from './nested-enumuser-status-filter.input';

@InputType()
export class Enumuser_statusWithAggregatesFilter {
