...
@ArgsType()
export class FindFirstcourierTerminalBalanceArgs {
    ...
    @Field(() => [Courier_terminal_balanceScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Courier_terminal_balanceScalarFieldEnum>;
}
