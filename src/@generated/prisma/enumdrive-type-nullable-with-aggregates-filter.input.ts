...
import { NestedEnumdrive_typeNullableWithAggregatesFilter } from './nested-enumdrive-type-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumdrive_typeNullableFilter } from './nested-enumdrive-type-nullable-filter.input';

@InputType()
export class Enumdrive_typeNullableWithAggregatesFilter {
