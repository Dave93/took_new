...
@ArgsType()
export class FindFirstscheduledReportsSubscriptionArgs {
    ...
    @Field(() => [Scheduled_reports_subscriptionScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Scheduled_reports_subscriptionScalarFieldEnum>;
}
