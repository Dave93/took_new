...
import { NestedEnumorganization_payment_typesWithAggregatesFilter } from './nested-enumorganization-payment-types-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumorganization_payment_typesFilter } from './nested-enumorganization-payment-types-filter.input';

@InputType()
export class Enumorganization_payment_typesWithAggregatesFilter {
