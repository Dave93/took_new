...
@ArgsType()
export class FindFirstdeliveryPricingArgs {
    ...
    @Field(() => [Delivery_pricingScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Delivery_pricingScalarFieldEnum>;
}
