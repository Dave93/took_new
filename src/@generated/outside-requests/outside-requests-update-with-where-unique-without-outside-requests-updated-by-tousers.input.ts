...
@InputType()
export class outside_requestsUpdateWithWhereUniqueWithoutOutside_requests_updated_byTousersInput {
    ...
    data!: outside_requestsUpdateWithoutOutside_requests_updated_byTousersInput;
}
