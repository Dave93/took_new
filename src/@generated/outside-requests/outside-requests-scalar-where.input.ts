...
@InputType()
export class outside_requestsScalarWhereInput {

    @Field(() => [outside_requestsScalarWhereInput], {nullable:true})
    AND?: Array<outside_requestsScalarWhereInput>;

    @Field(() => [outside_requestsScalarWhereInput], {nullable:true})
    OR?: Array<outside_requestsScalarWhereInput>;

    @Field(() => [outside_requestsScalarWhereInput], {nullable:true})
    NOT?: Array<outside_requestsScalarWhereInput>;
