...
@InputType()
export class work_schedulesUpdateWithWhereUniqueWithoutWork_schedules_created_byTousersInput {
    ...
    data!: work_schedulesUpdateWithoutWork_schedules_created_byTousersInput;
}
