...
@InputType()
export class users_rolesUpsertWithWhereUniqueWithoutUsers_usersTousers_roles_updated_byInput {
    ...
    update!: users_rolesUpdateWithoutUsers_usersTousers_roles_updated_byInput;
