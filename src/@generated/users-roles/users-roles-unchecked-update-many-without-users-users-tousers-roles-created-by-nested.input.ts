...
import { users_rolesUpsertWithWhereUniqueWithoutUsers_usersTousers_roles_created_byInput } from './users-roles-upsert-with-where-unique-without-users-users-tousers-roles-created-by.input';
...
import { users_rolesUpdateWithWhereUniqueWithoutUsers_usersTousers_roles_created_byInput } from './users-roles-update-with-where-unique-without-users-users-tousers-roles-created-by.input';
import { users_rolesUpdateManyWithWhereWithoutUsers_usersTousers_roles_created_byInput } from './users-roles-update-many-with-where-without-users-users-tousers-roles-created-by.input';
import { users_rolesScalarWhereInput } from './users-roles-scalar-where.input';

@InputType()
export class users_rolesUncheckedUpdateManyWithoutUsers_usersTousers_roles_created_byNestedInput {
    ...
    @Field(() => [users_rolesUpsertWithWhereUniqueWithoutUsers_usersTousers_roles_created_byInput], {nullable:true})
    @Type(() => users_rolesUpsertWithWhereUniqueWithoutUsers_usersTousers_roles_created_byInput)
    upsert?: Array<users_rolesUpsertWithWhereUniqueWithoutUsers_usersTousers_roles_created_byInput>;
    ...
    @Field(() => [users_rolesUpdateWithWhereUniqueWithoutUsers_usersTousers_roles_created_byInput], {nullable:true})
    @Type(() => users_rolesUpdateWithWhereUniqueWithoutUsers_usersTousers_roles_created_byInput)
    update?: Array<users_rolesUpdateWithWhereUniqueWithoutUsers_usersTousers_roles_created_byInput>;

    @Field(() => [users_rolesUpdateManyWithWhereWithoutUsers_usersTousers_roles_created_byInput], {nullable:true})
    @Type(() => users_rolesUpdateManyWithWhereWithoutUsers_usersTousers_roles_created_byInput)
    updateMany?: Array<users_rolesUpdateManyWithWhereWithoutUsers_usersTousers_roles_created_byInput>;
